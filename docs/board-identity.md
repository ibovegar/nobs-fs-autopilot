...
- Every Nobs box appears to your PC as a USB game controller with a **name** (like "Nobs Autopilot")
...
| | Name | ID |
| :-- | :-- | :-- |
| 1st autopilot | Nobs Autopilot | `80F4` |
| 2nd autopilot | Nobs Autopilot 2 | `80F5` |
...
The configuration app does this for you. Behind the scenes it just sends the board one short line of
text over its connection, for example:

```
SET_ID:80F4:Nobs Autopilot
```

That reads as: *"Set your ID to `80F4` and your name to `Nobs Autopilot`."* The board then:
